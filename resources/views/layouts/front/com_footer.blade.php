<footer class="footer -type-1 -bg-1 relative text-white">
    ...
    <div class="container">
        ...
        <div class="">
            ...
            Northwest Fishery specializes in exporting premium-quality seafood worldwide, ensuring freshness, sustainability, and excellence in every catch.
            </div>
        </div>
        <div class="">
            ...
            <div class="mt-25">
                <a class="d-block text-15 text-white-60" href="mailto:info@northwestfishery.lk;">
                info@northwestfishery.lk
                </a>
            </div>
            <div class="mt-10">
    ...
    <div class="container">
        ...
        <div class="col-sm-auto">
            <div class="text-15 text-center text-white-60">Copyright © 2025 by <a href="https://epartner.lk" target="_blank" title="ePartner Sri Lanka">ePartner.lk</a></div>
        </div>
        <div class="col-sm-auto">
